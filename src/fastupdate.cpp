...
/*implement add vertex in partition funciton sector*/
double InteractionExpansion::add_impl(const std::vector<double>& taus, const std::vector<site_t>& sites, const bool compute_only_weight)
{
