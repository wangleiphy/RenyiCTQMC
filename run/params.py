...
def params(lattice, L, W, NA0, NA1, V=1.0, T = 0.1, Maxorder = 2048, Ntau=500, Nscratch=5000, SWEEPS=1000000, THERMALIZATION=100000, NSKIP=200, Add=0.1, Remove = 0.2, ZtoW=0.1, WtoZ =0.1, folder='../data/', textoutput=0):
